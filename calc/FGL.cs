...
namespace calc {
    partial class MainWindow {
        class FGL { // Future Gadget Lab
            private static dynamic num1 = (decimal)0, num2 = (decimal)0, mem = (decimal)0;
            private static string op = "";
            private static bool action = false;
            private static dynamic Calc(dynamic num1, dynamic num2, string op, TextBox Display) {
                switch (op) {
                    case "+":
                        num1 += num2;
            ...
            public static void Operation(Button btn, TextBox Display, TextBox History) {
                if (History.Text.Length == 0) {
                    ...
                    try {
                        num1 = (decimal)num1;
                        num2 = (decimal)num2;
                        num1 = Calc(num1, num2, op, Display);
            ...
            public static void Equal(TextBox Display, TextBox History) {
                if (Display.Text != "0" && num2 == 0) {
                    try {
                        num1 = (decimal)num1;
                        num2 = (decimal)num2;
                        num1 = Calc(num1, num1, op, Display);
                    } catch (OverflowException) {
                        num1 = (double)num1;
                        num2 = (double)num2;
                        num1 = Calc(num1, num1, op, Display);
